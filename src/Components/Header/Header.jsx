               ...
               <Link> <p className="suboption">IELTS</p></Link>
                ...
                <TestNames className = "test_names">
                  <p className="link_para test_preparation">Courses</p>
                   <div className="names">
                   <Link to = "/courseArchieve">  <p className="suboption sat">Course Archieve</p></Link>
              <Link to = "/primaryEducation">  <p className="suboption">Primary Education</p> </Link>
                <Link to = "/secondaryEducation"><p className="suboption">Secondary Education</p></Link>
               <Link to = "/higherSecondaryEducation"> <p className="suboption">Higher Secondary Education</p></Link>
